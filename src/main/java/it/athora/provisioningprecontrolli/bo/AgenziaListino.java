...
public enum AgenziaListino {
	...
	BARI("Bari", new String[] { "001818", "001819", "1818", "1819" }, new String[] { "FilialeBanca", "DirezioneBanca" }), 
	BPER("Bper", new String[] { "001800", "001804", "1800", "1804" }, new String[] { "FILIALISTA Banca Bper" }), 
